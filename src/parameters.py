...
Rt_temp[:, :, 1] = np.diag([3]) * 1e-3 * a
Qt_temp[:, :, 2] = np.diag([1, 1, 1, 1]) * a
Rt_temp[:, :, 2] = np.diag([1]) * 1e-4 * a
...
Qt_temp_reg[:, :, 0] = np.diag([1, 1, 5000, 5000])  * (1/1.653676929332829) # Constant phase
Rt_temp_reg[:, :, 0] = np.diag([0.001]) * (1/44.78666325774839)                                 # Constant phase
Qt_temp_reg[:, :, 1] = np.diag([1, 1, 1000, 1000])                   # Transition phase
Rt_temp_reg[:, :, 1] = np.diag([0.001]) * (1/44.78666325774839)
...
# case 1:
state_initial_perturbation = 0.05
affine_perturbation_mpc = 0
noise_sensor = 0
noise_actuator = 0

# case 2: 
# state_initial_perturbation = -0.1
# affine_perturbation_mpc = 0
# noise_sensor = 0.005
# noise_actuator = 0.005
